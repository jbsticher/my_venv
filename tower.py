...
def main():
    ...
    print(
        """THE TOWER OF HANOI, by 'The man Al

Move the tower of disks, one disk at a time, to another tower. Larger disks cannot
rest on top of a smaller disk.
...
def getPlayerMove(towers):
    ...
    while True:  
        print('Enter the letters of "from" to "to" towers, or QUIT.')
